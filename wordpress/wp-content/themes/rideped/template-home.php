...
<main>
    <section
        class="relative hero-section md:flex md:items-center relative w-full bg-cover md:h-[964px] bg-no-repeat bg-left md:bg-right md:bg-[url('/wp-content/themes/rideped/assets/scooters-bg-rtl.svg')] bg-[url('/wp-content/themes/rideped/assets/scooters-bg-line-ltr.svg')]">
        <div class="container">
            <div class="flex mt-[40px]  px-[21px] md:px-[0] gap-[40px] md:flex-col">
                ...
                <div class="flex flex-col items-center gap-[24px] md:items-start">
                    ...
                    <img width="320" class="md:hidden w-[320px]"
                        src="<?php echo get_stylesheet_directory_uri() . '/assets/scooters.svg'; ?>" alt="">
                </div>
            </div>

            <!-- <img class="hidden md:block col-span-2" src="<?php echo get_stylesheet_directory_uri() . '/assets/scooters-bg-rtl.svg'; ?>" alt=""> -->
        </div>
    </section>
                ...
                while ($products->have_posts()):
                    ...
                    <div class="product flex flex-col rounded-md">
                        <div class="product-image relative flex justify-center items-center"
                            style="border-radius: 30px 30px 0 0; padding: 31px; background-image: url(<?php echo get_stylesheet_directory_uri() . '/assets/cement-wall-floor-copy-space.png'; ?>); background-repeat: no-repeat; background-size: cover;">
                            <?php echo $product->get_image('full', ['class' => 'max-w-full w-[319px] h-[319px] object-contain']); ?>
                            <?php if ($is_coming_soon): ?>
                                <img class="absolute top-0"
                                    src="<?php echo get_stylesheet_directory_uri() . '/assets/coming-soon-badge.svg'; ?>"
                                    alt="<?php _e('Coming Soon', 'rideped'); ?>" />
                            <?php endif; ?>
            ...
            <section
                ...
                <div class="container  md:gap-[80px] grid md:grid-cols-2 items-center">
                    ...
                    <div class="my-[50px] md:mt-[24px]">
                            ...
                            <div class="x-feature flex items-start gap-x-2">
                                <div class="x-feature-icon">
                                    <img class="w-8 min-w-8"
                                        src="<?php echo get_stylesheet_directory_uri() . '/assets/features/tire_6955616.svg'; ?>"
                                        alt="">
                                </div>
                        ...
                        <?php echo do_shortcode('[woo_buy_button text="' . __('Buy now', 'rideped') . '"]'); ?>
                ...
                <img class="absolute bottom-0 right-0 rotate-270 hidden md:block"
                    src="<?php echo get_stylesheet_directory_uri() . '/assets/Group-1171275044.svg'; ?>" alt="">
            </section>
            <?php
        endwhile;
        wp_reset_postdata();
...
<section class="px-[21px] md:px-[0]">
        ...
        <h2 class="text-center text-black text-[32px] mt-[24px] font-semibold font-['Inter'] capitalize leading-[30.34px] md:leading-[104.53px]">
            <?php _e('Upgrade your scooter', 'rideped'); ?>
        </h2>
                ...
                foreach ($categories as $category):
                    ...
                    <div class="product flex flex-col rounded-md">
                        <div class="product-image relative flex justify-center items-center"
                            ...
                            <img src="<?php echo $image ? esc_url($image[0]) : $default_image; ?>"
                                alt="<?php echo esc_attr($category->name); ?>" class="max-w-full w-[319px] h-[319px] object-contain" />


                        </div>
                        <div class="product-details !p-[30px] bg-black flex  items-center justify-center">Ç
    ...
    <section class="md:flex md:items-center bg-[#F2F2F2] mt-[24px]">
        ...
        <div class="container md:gap-[80px] grid md:grid-cols-2 items-center">
            ...
            <img class="w-full md:order-1"
                src="<?php echo get_stylesheet_directory_uri() . '/assets/rideped-tire.svg'; ?>" alt="">

            <div class="px-[21px] md:px-[0]">
                <h2 class="title left nomb"><?php _e('Rideped scooter', 'rideped'); ?></h2>
                <h3 class="primary-title"><?php _e('Innovative Tech and Modularity', 'rideped'); ?></h3>
                <p class="paragraph">
                    <?php _e('we never leave our customers behind when it comes to innovation. That\'s why our scooters are designed with a modular build, allowing for quick and easy part replacements. In other words, It\'s a next-level scooter that delivers an unbeatable ride experience, time after time!', 'rideped'); ?>
                </p>
                <button
                    class="hollow-btn py-2 px-6 mt-6 w-fit text-black"><?php _e('Learn More', 'rideped'); ?></button>
            </div>
    ...
    <section class="fit bg-white px-[21px] mt-[24px] md:px-none">
        ...
        <p class="paragraph text-center mb-4">
            <?php _e('Everything you need to know about the product and billing.', 'rideped'); ?>
        </p>
                ...
                while ($blog_posts->have_posts()):
                    ...
                    <div class="post flex flex-col">
                        ...
                        <a href="<?php the_permalink(); ?>" class="post-read-more">
                            ...
                            <img src="/wp-content/uploads/2024/09/Arrow.svg" alt="Arrow" />
                        </a>
                    </div>
                    <?php
                endwhile;
