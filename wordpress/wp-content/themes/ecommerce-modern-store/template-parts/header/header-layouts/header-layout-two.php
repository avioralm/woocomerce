        ...
        <div class="wpdevart-search-and-button-container-layouttwo">
            <?php if ( class_exists( 'WooCommerce' ) ) { ?>
                    ...
                    <div class="header-cart-layout-two">
                        <a class="cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'ecommerce-modern-store' ); ?>"><i class="fa-solid fa-cart-arrow-down wpdevart-woo-icon"></i><span class="custom-cart-count-layout-two"><div id="mini-cart-count"></div></span> </a> 
						<?php wpdevart_ecommerce_modern_store_header_cart_layout_two() ?>
                    </div>   
            <?php } ?>
