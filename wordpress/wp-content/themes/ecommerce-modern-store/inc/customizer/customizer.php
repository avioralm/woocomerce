...
function wpdevart_ecommerce_modern_store_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'wpdevart_ecommerce_modern_store_customize_register' );