...
if ( ! defined( 'AUTHOR_WRITER_FREE_THEME_URL' ) ) {
	define( 'AUTHOR_WRITER_FREE_THEME_URL', 'https://www.themespride.com/products/free-author-wordpress-theme' );
}
if ( ! defined( 'AUTHOR_WRITER_PRO_THEME_URL' ) ) {
	define( 'AUTHOR_WRITER_PRO_THEME_URL', 'https://www.themespride.com/products/author-writer-wordpress-theme' );
}
if ( ! defined( 'AUTHOR_WRITER_DEMO_THEME_URL' ) ) {
	define( 'AUTHOR_WRITER_DEMO_THEME_URL', 'https://page.themespride.com/author-writer-pro/' );
}
if ( ! defined( 'AUTHOR_WRITER_DOCS_THEME_URL' ) ) {
    define( 'AUTHOR_WRITER_DOCS_THEME_URL', 'https://page.themespride.com/demo/docs/author-writer-lite/' );
}
if ( ! defined( 'AUTHOR_WRITER_DOCS_URL' ) ) {
    define( 'AUTHOR_WRITER_DOCS_URL', 'https://page.themespride.com/demo/docs/author-writer-lite/' );
}
...
if ( ! defined( 'AUTHOR_WRITER_THEME_BUNDLE' ) ) {
    define( 'AUTHOR_WRITER_THEME_BUNDLE', 'https://www.themespride.com/products/wordpress-theme-bundle' );
}
