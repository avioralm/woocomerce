...
<section id="slider">
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-caption">
            <div class="inner_carousel">
             <h1><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
                <div class="more-btn">
                  <a class="me-3" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More','ecommerce-bookshop'); ?></a>
                </div>
            </div>
          </div>
        </div>
    ...
    <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-bs-slide="prev">
      ...
      <span class="screen-reader-text"><?php esc_html_e('Previous','ecommerce-bookshop'); ?></span>
    </a>
    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-bs-slide="next">
      <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-angle-right"></i></span>
      <span class="screen-reader-text"><?php esc_html_e('Next','ecommerce-bookshop'); ?></span>
    </a> 
  </div>
