    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 align-self-center">
        ...
        <?php if( get_theme_mod( 'author_writer_announcement_bar' ) != '') { ?>
          <p class="mb-md-0 mb-3"><i class="<?php echo esc_attr(get_theme_mod('author_writer_announcement_icon','fas fa-bullhorn')); ?> me-2"></i><?php echo esc_html( get_theme_mod('author_writer_announcement_bar','')); ?></p>
        <?php } ?>
        <?php } ?>
      </div>
