        ...
        <div class="hero-features mt-10 md:mt-0 flex flex-col gap-y-2">
            ...
            <div class="features-container flex flex-col gap-y-2 md:flex-row md:gap-x-2">
                <div class="feature flex gap-x-1 items-center md:flex-col">
                    ...
                    <div class="feature-text">ft1</div>
                </div>
                ...
                <div class="feature flex gap-x-1 items-center md:flex-col">
                    ...
                    <div class="feature-text">ft2</div>
                </div>
                ...
                <div class="feature flex gap-x-1 items-center md:flex-col">
                    ...
                    <div class="feature-text">ft3</div>
                </div>
            </div>
...
<section class="relative">
    ...
    <div class="products flex flex-col gap-y-4 md:flex-row md:justify-evenly">
		...
		<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             ...
             <?php ($is_coming_soon = count($product->tag_ids) != 0); ?>
<div class="product flex flex-col rounded-md">
                    <div class="product-image relative">
                        <img src="<?php echo e(wp_get_attachment_image_url( $image_id, 'full' )); ?>" />
...
<section class="hero2 fit mdhscreen md:flex md:items-center">
    ...
    <div class="hero2-content md:mx-24 md:text-start">
        <div class="title left nomb">hero2 rurke</div>
...
<section class="fit bg-white">
    ...
    <details>
        <summary>
            <span class="summary-title"><?php echo e($faq['question']); ?></span>
            <div class="summary-chevron-up">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
            </div>
        </summary>

        <div class="summary-content"><?php echo e($faq['answer']); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/wp-content/themes/rideped/resources/views/front-page.blade.php ENDPATH**/ ?>